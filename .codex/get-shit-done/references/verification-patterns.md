...
**@/Users/danghamo/Documents/gituhb/magam-feature-database-first-canvas-platform/.codex/get-shit-done/references/checkpoints.md** → `<automation_reference>` section
