...
- **Global scope**: `/Users/danghamo/Documents/gituhb/magam-feature-database-first-canvas-platform/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/danghamo/Documents/gituhb/magam-feature-database-first-canvas-platform/.codex/notes/`)
...
2. Glob `/Users/danghamo/Documents/gituhb/magam-feature-database-first-canvas-platform/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/danghamo/Documents/gituhb/magam-feature-database-first-canvas-platform/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/danghamo/Documents/gituhb/magam-feature-database-first-canvas-platform/.codex/notes/` — works in any directory
