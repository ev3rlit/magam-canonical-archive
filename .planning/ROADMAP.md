...
Plans:
- [ ] 01-01-PLAN.md — Workspace and document canvas entry convergence
- [ ] 01-02-PLAN.md — Viewport, selection, drag, resize, and rotate baseline
- [ ] 01-03-PLAN.md — Minimal shape set and creation flows
...
|-------|----------------|--------|-----------|
| 1. Canvas Core Authoring | 0/6 | Not started | - |
