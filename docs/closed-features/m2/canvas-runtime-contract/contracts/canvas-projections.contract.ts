...
import type { CanvasRuntimeCommandNameV1 } from './canvas-command-language.contract';

// Read-side projections exposed as part of the Canvas Runtime published language.
