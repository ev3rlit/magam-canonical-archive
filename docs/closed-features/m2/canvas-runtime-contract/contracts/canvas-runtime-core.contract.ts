// Core runtime model shared inside the Canvas Runtime bounded context.
// This file defines aggregate roots, entities, and value-object-like components.
...
// Rotation is expressed as an absolute clockwise angle in degrees.
// Public contracts normalize this value to the half-open range [0, 360).
