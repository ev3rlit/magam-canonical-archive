// External contract for AI-first canonical bulk mutation requests.
// This contract expresses domain intent and must not be interpreted as a raw DB patch surface.
