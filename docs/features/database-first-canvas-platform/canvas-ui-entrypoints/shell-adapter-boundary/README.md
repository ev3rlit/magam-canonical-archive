...
`shell-adapter-boundary`의 one-time adoption은 아래 4개 consumer sub-task로도 읽을 수 있다.

### 1. `graph-canvas-host-consumer`

- 폴더: `./graph-canvas-host-consumer/`
- 문서: `./graph-canvas-host-consumer/README.md`
- 목표: `GraphCanvas.tsx`를 toolbar/menu wiring owner가 아니라 host consumer로 축소

### 2. `floating-toolbar-presenter-consumer`

- 폴더: `./floating-toolbar-presenter-consumer/`
- 문서: `./floating-toolbar-presenter-consumer/README.md`
- 목표: `FloatingToolbar.tsx`를 presenter state/policy owner가 아니라 presenter consumer로 축소

### 3. `context-menu-binding-consumer`

- 폴더: `./context-menu-binding-consumer/`
- 문서: `./context-menu-binding-consumer/README.md`
- 목표: `useContextMenu.ts`를 pane/node registry owner가 아니라 context-menu binding consumer로 축소

### 4. `workspace-client-dispatch-consumer`

- 폴더: `./workspace-client-dispatch-consumer/`
- 문서: `./workspace-client-dispatch-consumer/README.md`
- 목표: `WorkspaceClient.tsx`를 dispatch orchestration owner가 아니라 action-dispatch binding consumer로 축소
